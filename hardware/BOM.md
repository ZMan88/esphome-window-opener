...
| 1 | DC-DC step-down buck 12V → 5V | **Recommended:** small MPS-based module (MP1584EN or similar, ~22 × 14 mm). [robofun.ro MP1584](https://www.robofun.ro/surse-de-alimentare/mp1584en-mini-lm2596-ultra-small-dc-dc-3a-power-step-down-adjustable-module-buck-converter-24v-turn-12v-9v-5v.html) · AliExpress. **Alternative:** [optimusdigital.ro LM2596 5A](https://www.optimusdigital.ro/en/adjustable-step-down-power-supplies/1109-lm2596-dc-dc-step-down-module-5a.html) — bigger but interchangeable. Either is fine; both run cool at our ~270 mA logic load. | 5–20 | 1–4 |
